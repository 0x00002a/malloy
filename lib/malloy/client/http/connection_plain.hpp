...
namespace malloy::client::http
{
    ...
    public:
        connection_plain(std::shared_ptr<spdlog::logger> logger, boost::asio::io_context& io_ctx, bool follow_redirects) :
            parent_t(std::move(logger), io_ctx, follow_redirects),
